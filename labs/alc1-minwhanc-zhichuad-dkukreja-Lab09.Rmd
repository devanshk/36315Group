...
Anthony is from Dallas, Texas. He's a CS Major and Stats Double.
Zhichuan is from Beijing, China. He's a Stats-ML major with a double in Robotics.
Minwhan is from Korea. He's an Econ-Stat major.
Devansh (me) is from Seattle. He's an IS Major with a CS double.
